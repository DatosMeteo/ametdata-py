...
- [Obtención de API Key](#obtención-de-api-key)
- [Cuaderno de ejemplos interactivo](#cuaderno-de-ejemplos-interactivo)
- [Cliente y funciones principales](#cliente-y-funciones-principales)
- [Avisos](#avisos)
...
### AemetClient
Clase principal para interactuar con la API de AEMET OpenData. Permite descargar datos de cualquier endpoint autorizado.
